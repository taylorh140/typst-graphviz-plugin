...
void CFrmSettings::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<CFrmSettings *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject CFrmSettings::staticMetaObject = { {
    &QDialog::staticMetaObject,
    qt_meta_stringdata_CFrmSettings.data,
    qt_meta_data_CFrmSettings,
    qt_static_metacall,
    nullptr,
    nullptr
} };
